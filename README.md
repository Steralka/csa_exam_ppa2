...
**Вычислительная платформа** — это среда, в которой выполняются вычисления, и которая описывается через четыре компонента.
...
<img width="466" height="1121" alt="level-of-abstraction-for-computing-system-vert" src="https://github.com/user-attachments/assets/2c0c4e2e-e472-49be-b5e1-f8764114d521" />
...
<img width="2904" height="3723" alt="vertical-horizontal-arch" src="https://github.com/user-attachments/assets/3d81c088-8061-4edf-af13-e04500c5d771" />
...
<img width="880" height="648" alt="image" src="https://github.com/user-attachments/assets/e8f399b9-f227-4b4e-90d7-39aee8f7eb26" />
...
### 3 БЛОК
1. <!-- 3 --> Сравните подходы к реализации вычислений в арифмометре и на логарифмической линейке. Какие аналогии можно провести с современными компьютерами?
...
### 5 БЛОК
1. <!-- 5 --> Каковы ключевые тенденции в производстве радиоэлектронной аппаратуры и связанные с этим проблемы?
...
### 6 БЛОК
1. <!-- 6 --> Каково определение программной системы согласно OMG Essence? Каковы её части?
...
### 7-8-9 БЛОК
1. <!-- 7-8-9 --> Что такое универсальный процессор? Каковы его особенности и свойства?
...
### 10-11 БЛОК
1. <!-- 10-11 --> Каковы шаги типового взаимодействия с устройством ввода-вывода? Каков интерфейс устройства для процессора?
...
### 12-13 БЛОК
1. <!-- 12-13 --> Почему необходима иерархия памяти в современных компьютерных системах?
...
### 14 БЛОК
1. <!-- 14 --> Что представляет собой концепция уровневой организации компьютерных систем и каковы её преимущества?
